...
setMotorSpeed(LEFT_MOTOR_PIN1, LEFT_MOTOR_PIN2, left_pwm);
setMotorSpeed(RIGHT_MOTOR_PIN1, RIGHT_MOTOR_PIN2, right_pwm);
last_cmd_time = millis();
}
}
}
...
digitalWrite(dirPin, forward ? LOW : HIGH); // LOW/HIGH mapping per your shield
